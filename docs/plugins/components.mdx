...
| `onChange`                  | <Required /> (e: `RadioOptionType`) => void |                      | Function ran on value change                              |
| `options`                   | <Required /> `RadioOptionType[]`            |                      | Array of radio options; check out `RadioOptionType` props |
...
| `options`           | <Required /> `SelectOptionType[]` |          | Array of select options; check out `SelectOptionType` props                                                 |
