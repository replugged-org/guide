...
- Most props are optional unless specified with **(required)** in the type!
- Enums found on this page are only accessible by the original component! (e.g. `Item` components
  cannot access them)
...
| Name             | Type                                 | Default            | Description                                        |
| ---------------- | ------------------------------------ | ------------------ | -------------------------------------------------- |
| `align`          | `Checkbox.Aligns`                    | `CENTER`           | Alignment of the elements inside the checkbox      |
...
| `shape`          | `Checkbox.Shapes`                    | `BOX`              | Define checkbox shape                              |
| `size`           | number                               | `24`               | Checkbox width and height                          |
| `style`          | <CSSProperties />                    |                    | Component style                                    |
| `type`           | `Checkbox.Types`                     | `DEFAULT`          | Define checkbox type                               |
...
| `size`                      | `Radio.Sizes`                                 | `MEDIUM` | Define radio group size                                   |
...
| `onKeyDown`      | (e: KeyboardEvent) => void |           | Function ran on key press                        |
| `placeholder`    | string                     |           | Input placeholder text                           |
| `size`           | `TextInput.Sizes`          | `DEFAULT` | Define the input size                            |
| `style`          | <CSSProperties />          |           | Component style                                  |
...
| `className`               | string                     |                    | Component class name                                                                         |
| `color`                   | `Button.Colors`            | `BRAND`            | Button color                                                                                 |
...
| `look`                    | `Button.Looks`             | `FILLED`           | Button look                                                                                  |
...
| `size`                    | `Button.Sizes`             | `MEDIUM`           | Button size                                                                                  |
| `style`                   | <CSSProperties />          |                    | Component style                                                                              |
...
| Name        | Type              | Default      | Description       |
| ----------- | ----------------- | ------------ | ----------------- |
| `align`     | `Flex.Align`      | `STRETCH`    | Flexbox align     |
| `basis`     | string            | `auto`       | Flexbox basis     |
| `direction` | `Flex.Direction`  | `HORIZONTAL` | Flexbox direction |
| `grow`      | number            | `1`          | Flexbox grow      |
| `justify`   | `Flex.Justify`    | `START`      | Flexbox justify   |
| `shrink`    | number            | `1`          | Flexbox shrink    |
| `style`     | <CSSProperties /> |              | Component style   |
| `wrap`      | `Flex.Wrap`       | `NO_WRAP`    | Flexbox wrap      |
...
| `style`         | <CSSProperties /> |                   | Component style                                  |
| `type`          | `Loader.Type`     | `WANDERING_CUBES` | Define type of loader                            |
...
| Name                          | Type                           | Default   | Description                                                                       |
| ----------------------------- | ------------------------------ | --------- | --------------------------------------------------------------------------------- |
| `align`                       | `Tooltip.Aligns`               | `CENTER`  | Tooltip alignment to the children; works together with `position`                 |
| `allowOverflow`               | boolean                        | `false`   | Whether the tooltip content can overflow                                          |
| `className`                   | string                         |           | Component class name                                                              |
| `color`                       | `Tooltip.Colors`               | `PRIMARY` | Sets color of the tooltip                                                         |
...
| `position`                    | `Tooltip.Positions`            | `TOP`     | Tooltip position; works together with `align`                                     |
