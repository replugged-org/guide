...
| `onChange`                  | function **(required)**            |          | Function ran on value change                              |
...
| `isSelected`        | function **(required)**             |          | Function ran to check if the option passed as a parameter is selectable; not necessary if `value` is passed |
| `look`              | number                              | `0`      | Define the select style                                                                                     |
| `maxVisibleItems`   | number                              | `7`      | How many options are visible                                                                                |
| `onChange`          | function **(required)**             |          | Function ran on selection change; alias of `onSelect` and `select`                                          |
...
| `onSelect`          | function **(required)**             |          | Function ran on selection change; alias of `onChange` and `select`                                          |
...
| `select`            | function **(required)**             |          | Function ran on selection change; alias of `onChange` and `onSelect`                                        |
...
| `onChange`    | function **(required)** |         | Function ran on state change                                     |
| `style`       | <CSSProperties />       |         | Component style                                                  |
...
| `onClick`                 | function **(required)** |                    | Function ran on button click                                                                 |
...
| `onClick`              | function **(required)** |         | Function ran when clicking the close button              |
