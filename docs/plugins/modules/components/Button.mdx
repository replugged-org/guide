...
| Enum            | Description                                                                                                                        |
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| `Button.Colors` | Button colors <br />`BRAND` \| `BRAND_INVERTED` \| `RED` \| `GREEN` \| `PRIMARY` \| `LINK` \| `WHITE` \| `TRANSPARENT` \| `CUSTOM` |
| `Button.Looks`  | Button styles <br />`FILLED` \| `OUTLINED` \| `LINK` \| `BLANK`                                                                    |
| `Button.Sizes`  | Button sizes <br />`NONE` \| `TINY` \| `SMALL` \| `MEDIUM` \| `LARGE` \| `MIN` \| `MAX` \| `ICON`                                  |
