...
<!-- [!]: `CaptchaPayload`, `ChannelMessages`, `FetchMessagesOptions`, `LocalFetchComplete`, `MessageJumpOptions` and all functions starting with an underscore aren't documented -->
...
| `position`       | [`Tooltip.Positions`](components#tooltip)     |         | Context menu position               |
...
| Name                   | Type                                      | Default | Description                                                            |
| ---------------------- | ----------------------------------------- | ------- | ---------------------------------------------------------------------- |
| `align`                | [`Tooltip.Aligns`](components#tooltip)    |         | Context menu alignment to the children; works together with `position` |
...
| `position`             | [`Tooltip.Positions`](components#tooltip) |         | Context menu position; works together with `align`                     |
...
| `className`            | string                               |                       | Component class name                           |
| `confirmColor`         | [`Button.Colors`](components#Button) | `Button.Colors.BRAND` | Primary button color                           |
