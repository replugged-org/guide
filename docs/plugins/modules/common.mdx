...
| `endEditMessage`                | <Required /> `channelId`: string <br /> <Required /> `response`: [`HTTPResponse`](#HTTPResponse)                                                                                                                | void                                                              | Dispatches an edited message                                                                       |
...
| `findByTag`                       | <Required /> `username`: string <br /> <Required /> `discriminator`: string                                         | <APIReferences.User /> \| undefined                           | Gets the user by its username and discriminator                    |
...
| `body`              | string \| Record<string, unknown>                                                                                                                         |           | Body for the request                                                                                                                                  |
