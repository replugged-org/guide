...
| `tooltipPosition`    | [`Tooltip.Positions`](#tooltip) |         | Tooltip position displayed on the option |
...
| `popoutPosition`    | [`Tooltip.Positions`](#tooltip)                               |                       | Popout position displayed on the select                                                                     |
...
| `tooltipPosition`         | [`Tooltip.Positions`](#tooltip) |                       | Tooltip position displayed on the button item                                                |
...
| `onClose`      | <Required /> () => void |            | Function ran when the context menu got closed; check out [`contextMenu.close`](common#contextmenu) |
