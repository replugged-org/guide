...
| `onChange`       | (e: ChangeEvent, state: boolean) => void |                          | Function ran on value change                                       |
...
| `onChange`                  | <Required /> (e: [`RadioOptionType`](#RadioOptionType)) => void |                      | Function ran on value change           |
...
| `tooltipPosition` | string              |         | Tooltip position displayed on the option; check out [`Tooltip.Positions`](#tooltip) |
...
| `isSelected`        | <Required /> (e: string) => void                       |          | Function ran to check if the option passed as a parameter is selectable; not necessary if `value` is passed |
| `look`              | number                                                 | `0`      | Define the select style                                                                                     |
| `maxVisibleItems`   | number                                                 | `7`      | How many options are visible                                                                                |
| `onChange`          | <Required /> (e: string) => void                       |          | Function ran on selection change; alias of `onSelect` and `select`                                          |
...
| `onSelect`          | <Required /> (e: string) => void                       |          | Function ran on selection change; alias of `onChange` and `select`                                          |
...
| `popoutPosition`    | string                                                 |          | Popout position displayed on the select; check out [`Tooltip.Positions`](#tooltip)                          |
| `popoutWidth`       | number                                                 |          | Popout width                                                                                                |
| `renderOptionLabel` | (e: [`SelectOptionType`](#SelectOptionType)) => void   |          | Function ran on option label element render, useful to labels                                               |
| `renderOptionValue` | (e: [`SelectOptionType`](#SelectOptionType)[]) => void |          | Function ran on option value element render, useful to values                                               |
| `select`            | <Required /> (e: string) => void                       |          | Function ran on selection change; alias of `onChange` and `onSelect`                                        |
...
| `onChange`    | <Required /> (e: boolean) => void |         | Function ran on state change                                     |
| `style`       | <CSSProperties />                 |         | Component style                                                  |
...
| `button`                  | <Required /> string        |                       | Button text for the item component                                                           |
| `className`               | string                     |                       | Component class name                                                                         |
...
| `onClick`                 | <Required /> () => void    |                       | Function ran on button click                                                                 |
...
| `tooltipPosition`         | string                     |                       | Tooltip position displayed on the button item; check out [`Tooltip.Positions`](#tooltip)     |
...
This component requires the use of the common module [`contextMenu`](common#contextmenu).
...
| `position` | string |         | Position of the image; `left` or `right` |
