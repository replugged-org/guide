...
{/* [!]: `Cache` and `Snapshot` aren't documented */}
...
| `handleLoadCache`                 | <Required /> `cache`: `Cache`                                                                                       | void                                                                      | Loads user and channel data into memory from a cache               |
...
| `takeSnapshot`                    |                                                                                                                     | `Snapshot`                                                                | Takes a snapshot of the store                                      |
