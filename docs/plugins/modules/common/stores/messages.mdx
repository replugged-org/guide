...
{/* [!]: `ChannelMessages`, `FetchMessagesOptions`, `MessageJumpOptions`, `Poll`, `RemoteFetch`, `UserServer` and all functions starting with an underscore aren't documented */}
...
| `fetchLocalMessages`            | <Required /> `channelId`: string <br /> <Required /> `before`: boolean <br /> <Required /> `after`: boolean <br /> <Required /> `limit`: number <br /> <Required /> `remoteFetch`: `RemoteFetch`                 | Promise\<void>                                                              | Fetches local messages                                                                              |
...
| `sendBotMessage`                | <Required /> `channelId`: string <br /> <Required /> `content`: string <br /> `messageName`: string <br /> `messageId`: string                                                                                   | void                                                                        | Clyde sends a custom message                                                                        |
...
| `sendExplicitMediaClydeError`   | <Required /> `channelId`: string <br /> <Required /> `attachments`: <APIReferences.MessageAttachment />[] \| undefined <br /> <Required /> `context`: string                                                     | void                                                                        | Clyde sends an error message for explicit media                                                     |
...
| `startEditMessage`              | <Required /> `channelId`: string <br /> <Required /> `messageId`: string <br /> <Required /> `content`: string <br /> `source`: string                                                                           | void                                                                        | Starts editing a message                                                                            |
...
| `changelogId`      | string                                  |         | Id of the changelog                            |
| `channelId`        | <Required /> string                     |         | Id of the channel where the message belongs to |
| `content`          | <Required /> string                     |         | Content of the message                         |
