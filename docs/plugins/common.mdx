...
| `parseEmbedTitle`                  | `text`: string **(required)** <br /> `inline`: boolean <br /> `opts`: `ParseOpts` | ReactElement          | `parse` function but with `codeBlock`, `br`, `mention`, `channel` and `roleMention` rules ommitted        |
| `parseForumPostGuidelines`         | `text`: string **(required)** <br /> `inline`: boolean <br /> `opts`: `ParseOpts` | ReactElement          | `parse` function but with `paragraph` and `newline` rules ommitted                                        |
| `parseForumPostMostRecentMessage`  | `text`: string **(required)** <br /> `inline`: boolean <br /> `opts`: `ParseOpts` | ReactElement          | `parse` function but with some emoji sizing changes and `blockQuote`, `codeBlock` and `br` rules ommitted |
| `parseGuildEventDescription`       | `text`: string **(required)** <br /> `inline`: boolean <br /> `opts`: `ParseOpts` | ReactElement          | `parse` function but with `codeBlock`, `blockQuote` and `br` rules ommitted                               |
| `parseGuildVerificationFormRule`   | `text`: string **(required)** <br /> `inline`: boolean <br /> `opts`: `ParseOpts` | ReactElement          | `parse` function but with `codeBlock`, `br` and `blockQuote` rules ommitted                               |
| `parseInlineReply`                 | `text`: string **(required)** <br /> `inline`: boolean <br /> `opts`: `ParseOpts` | ReactElement          | `parse` function but with `blockQuote`, `codeBlock` and `br` rules ommitted                               |
| `parseTopic`                       | `text`: string **(required)** <br /> `inline`: boolean <br /> `opts`: `ParseOpts` | ReactElement          | `parse` function but with `inlineCode`, `codeBlock`, `br` and `blockQuote` rules ommitted                 |
| `reactParserFor`                   | `rules`: Record<string, Rule> **(required)**                                      | (...) => ReactElement | Creates a new parser function based on certain rules                                                      |
