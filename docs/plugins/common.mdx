...
| `reactParserFor`                   | `rules`: Record<string, Rule> **(required)**                                      | (...) => ReactElement | Creates a new parser function based on specific rules; the returned function has the same parameters of the functions above |
