...
| `getBasicChannel`                        | `channelId`: string **(required)** | <APIReferences.Channel /> \| undefined    | Gets the basic channel by its id                            |
| `getCachedChannelJsonForGuild`           | `channelId`: string **(required)** | unknown                                   | Gets the cached channel in JSON by its id                   |
| `getChannel`                             | `channelId`: string **(required)** | <APIReferences.Channel /> \| undefined    | Gets the channel by its id                                  |
...
| `getDMFromUserId`                        | `userId`: string **(required)**    | string \| undefined                       | Gets the DM channel id by its user id                       |
...
| `getLastSelectedChannels`                | `guildId`: string **(required)**   | string \| undefined                       | Gets the last selected channel id by its guild id           |
...
| `hasChannel`                             | `channelId`: string **(required)** | boolean                                   | Checks if the channel id is registered in the channel store |
| `hasRestoredGuild`                       | `guildId`: string **(required)**   | boolean                                   | Checks if the guild's channels are restored                 |
...
| `getLastSelectedTimestamp` | `guildId`: string **(required)** | number                                  | Gets the timestamp of when a specific guild was last selected         |
...
| Name                              | Parameters                                                                                                             | Return Type                                                   | Description                                                        |
| --------------------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------- | ------------------------------------------------------------------ |
| `filter`                          | `predicate`: (user: <APIReferences.User />) => <APIReferences.User /> \| boolean **(required)** <br /> `sort`: boolean | <APIReferences.User />[]                                      | Filters all users                                                  |
...
| `forEach`                         | `callback`: (user: <APIReferences.User />) => unknown **(required)**                                                   | void                                                          | Runs a function on each user                                       |
...
| Name         | Parameters                                                                                                               | Return Type              | Description                                                                  |
| ------------ | ------------------------------------------------------------------------------------------------------------------------ | ------------------------ | ---------------------------------------------------------------------------- |
| `alert`      | `props`: `AlertProps` **(required)**                                                                                     | void                     | Brings up a modal useful for a quick response                                |
| `closeModal` | `modalKey`: string **(required)** <br /> `contextKey`: string                                                            | void                     | Closes a specific modal by its key                                           |
...
| `reactParserFor`                   | `rules`: Record<string, Rule> **(required)**                                      | (...) => ReactElement | Creates a new parser function based on specific rules; the returned function has the same parameters of the other parser functions |
...
| Name    | Parameters                                                                                                      | Return Type | Description                                                                  |
| ------- | --------------------------------------------------------------------------------------------------------------- | ----------- | ---------------------------------------------------------------------------- |
| `toast` | `content`: string \| ReactElement \| null **(required)** <br /> `kind`: `toast.Kind` <br /> `opts`: `ToastOpts` | void        | Makes a toast appear on the screen; `toast.Kind.SUCCESS` is the default type |
...
| Name          | Parameters                         | Return Type | Description                                        |
| ------------- | ---------------------------------- | ----------- | -------------------------------------------------- |
| `startTyping` | `channelId`: string **(required)** | void        | Starts your typing indicator in a specific channel |
| `stopTyping`  | `channelId`: string **(required)** | void        | Stops your typing indicator in a specific channel  |
