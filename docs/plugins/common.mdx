...
| Name                            | Parameters                                                                                                                                                                                         | Return Type                                          | Description                                                  |
| ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------- | ------------------------------------------------------------ |
| `clearChannel`                  | <Required /> `channelId`: string                                                                                                                                                                   | void                                                 | Clears a channel from all messages                           |
| `crosspostMessage`              | <Required /> `channelId`: string <br /> <Required /> `messageId`: string                                                                                                                           | Promise<`Response` \| void>                          | Makes a message public in an announcement channel            |
...
| `endEditMessage`                | <Required /> `channelId`: string <br /> <Required /> `response`: `Response`                                                                                                                        | void                                                 | Dispatches an edited message                                 |
...
| `getSendMessageOptionsForReply` | <Required /> `options`: `SendMessageForReplyOptions`                                                                                                                                               | `SendMessageOptionsForReply` \| Record<never, never> | Gets options for a reply                                     |
...
| `sendGreetMessage`              | <Required /> `channelId`: string <br /> <Required /> `stickerId`: string <br /> `options`: `MessageGreetOptions`                                                                                   | Promise<`Response` \| void>                          | Sends a greet message                                        |
| `sendInvite`                    | <Required /> `channelId`: string <br /> <Required /> `inviteCode`: string <br /> `analyticsTriggeredFrom`: string <br /> `suggestedInvite`: `InviteSuggestion`                                     | Promise<`Response` \| void>                          | Sends an invite                                              |
| `sendMessage`                   | <Required /> `channelId`: string <br /> <Required /> `message`: `OutgoingMessage` <br /> `promise`: boolean <br /> `options`: `OutgoingMessageOptions`                                             | Promise<`Response` \| void>                          | Sends a message                                              |
| `sendStickers`                  | <Required /> `channelId`: string <br /> <Required /> `stickersIds`: string[] <br /> `content`: string <br /> `options`: `SendMessageOptionsForReply` \| Record<never, never> <br /> `tts`: boolean | Promise<`Response` \| void>                          | Sends a sticker                                              |
...
| `trackInvite`                   | <Required /> `options`: `TrackInviteOptions`                                                                                                                                                       | void                                                 | Tracks an invite for analytics                               |
...
`OutgoingMessageOptions` Props:

| Name               | Type                  | Default | Description                                             |
| ------------------ | --------------------- | ------- | ------------------------------------------------------- |
| `activityAction`   | `ActivityActionTypes` |         | Activity action type                                    |
...
`SendMessageForReplyOptions` Props:
...
`SendMessageOptionsForReply` Props:
...
class UserMessagesStore extends Flux.Store {
  public userMessagesMap: Map<string, Map<string, Message>>;
  ...
  public constructor() {
    super(Dispatcher, {
      MESSAGE_CREATE: ({ message }) => {
        /*
          ...
          So, only when the dispatcher received the MESSAGE_CREATE action type.
        */
        if (message.state === "SENDING") return;

        const userId = message.author.id;
        const userMessages = this.userMessagesMap.get(userId) ?? new Map();

        userMessages.set(message.id, message);

        this.userMessagesMap.set(userId, userMessages);
      },
      USER_MESSAGES_DELETE: ({ userId }) => {
    ...
    this.userMessagesMap = new Map(); // Here are stored all our users and their messages
  }

  public clearUserMessages(userId: string): void {
    // Function to delete a user from userMessagesMap
    if (this.userMessagesMap.has(userId)) {
      this.userMessagesMap.delete(userId);
    }
  }
}

export default new UserMessagesStore();
```
...
class UserMessagesStore extends Flux.Store {
  ...
  public constructor() {
    // ...
    this.userMessagesMap = new Map();
    // highlight-next-line
    this.displayName = "UserMessagesStore";
  }
  ...
  public __getLocalVars(): Record<string, unknown> {
    return {
      userMessagesMap: this.userMessagesMap,
    };
  }
  // highlight-end
}
