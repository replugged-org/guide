...
All properties are optional unless they are marked with an asterisk ( <Required /> ).
...
| author&nbsp;<Required />      | [Author&nbsp;\|&nbsp;Author[]](#author) | The author(s) of your addon. Array cannot be empty.                                                                                                                                                   |
